...
label = Label(top_frame, text="Player "+player + " Turn", font=('arial',50), bg = "green", fg ="white")
label.place(x=320,y= 150)

reset_button = Button(top_frame, text="Reset", font=('arial',12), bg="black", fg ="white", command=new_game)
